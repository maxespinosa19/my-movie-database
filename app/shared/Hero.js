      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="flex flex-col mb-16 items-center text-center
          ...
          <p className="mb-8 leading-relaxed">
            ...
            <a href="https://www.imdb.com/title/tt0137523" className="text-white bg-orange-400 border-0 py-2 px-6 rounded-lg text-lg hover:bg-orange-500 ">
              Learn More</a>
        </div>
        <div className="w-5/6 md:1/2 lg:w-full lg:max-w-lg">
